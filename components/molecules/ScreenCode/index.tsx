...
const ScreenCode: React.FC = () => {
  ...
  return (
    <div className="device w-full">
      <div id="code_lines" className="code-lines flex flex-col font-mono text-[9px] xs:text-xs md:text-sm shadow-sm border border-lines bg-surface rounded-md w-full h-[180px] xs:h-[220px] sm:h-[320px] md:h-[400px] overflow-hidden">
