...
const ScreenCode: React.FC = () => {
  ...
  return (
    <div className="device w-full">
      <div id="code_lines" className="code-lines flex flex-col font-mono text-[9px] xs:text-xs md:text-sm shadow-sm border border-lines bg-surface rounded-md w-full h-[200px] xs:h-[240px] sm:h-[340px] md:h-[440px] lg:h-[450px] overflow-hidden">
