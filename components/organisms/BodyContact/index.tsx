...
const BodyContact: React.FC = () => {
  ...
  return (
    <div className="contact">
        ...
        <div className="form-email border border-lines hover:border-accent transition-colors duration-300 rounded-md p-6 bg-surface/60 backdrop-blur-sm relative group shadow-sm">
