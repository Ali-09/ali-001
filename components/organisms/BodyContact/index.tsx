...
const BodyContact: React.FC = () => {
  ...
  return (
    <div className="contact">
        ...
        <div className="form-email border border-lines hover:border-accent hover:-translate-y-0.5 transition-all duration-300 rounded-md p-4 sm:p-6 bg-surface relative group shadow-sm mt-2 lg:mt-0">
