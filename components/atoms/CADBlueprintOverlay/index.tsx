...
const CADBlueprintOverlay: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none select-none z-0 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute top-16 sm:top-20 bottom-8 sm:bottom-12 left-2 sm:left-4 md:left-64 right-2 sm:right-4 md:right-6 border border-lines/25 rounded-sm">
